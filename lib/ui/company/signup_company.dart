...
class _SignupCompanyState extends State<SignupCompany> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<CompanySignUpBloc>(create: (context) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    BlocBuilder<CompanySignUpBloc, CompanySignUpState>(
                      builder: (BuildContext context, CompanySignUpState state) {
                        ...
                        }, child: state != CompanySignUpLoading?const Text('ثبت نام'):CircularProgressIndicator(
