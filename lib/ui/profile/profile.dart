...
import 'package:parvaz_event/data/student/bloc/profile_student_bloc.dart';
...
class StudentProfileScreen extends StatefulWidget {
  const StudentProfileScreen({Key? key, required this.meli}) : super(key: key);
  final int meli;
            ...
            if(state is ProfileStudentSuccess){
              ...
              for(int i = 0; i < temp; i++){
                if(!studentSkills.contains(state.student.maharats![i])){
                  studentSkills.add(state.student.maharats![i]);
                }
              }
            return Scaffold(
                    ...
                    child: SliverAppBar(
                      ...
                      flexibleSpace: FlexibleSpaceBar(
                        ...
                        title: Container(
                            ...
                            child: Text("${state.student.nam??""} ${state.student.namKhanevadegi??""}"
                            ,
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                boxShadow: [
                                  BoxShadow(color: LightTheme.shadowColor,
                              ...
                              children: [
                                    ...
                                    Expanded(
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(state.student.namKhanevadegi??"",
                                            textAlign: TextAlign.center,
                                            style: theme.textTheme.bodyMedium!
                                                .copyWith(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(state.student.mahalZendegi??"",
                                      textAlign: TextAlign.center,
                                      style: theme.textTheme.bodyMedium!
                                          .copyWith(
                                          fontWeight: FontWeight.w600),
    ...
    return DropdownButtonHideUnderline(
      child: DropdownButton2<String>(
        ...
        onChanged: (value) {
          if (value != null) {
            setState(() {
              if(!studentSkills.contains(value)){
